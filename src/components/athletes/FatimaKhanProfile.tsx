...
const FatimaKhanProfile = () => {
  ...
  const athleteData = {
    ...
    bio: "A fierce competitor with lightning-fast reflexes and exceptional court coverage. Fatima has dominated the national badminton circuit and is a role model for aspiring female athletes. Her strategic gameplay and mental toughness make her one of the most formidable players in the country.",
    specialties: [
      { name: "Singles", level: 94, category: "Playing Style" },
      { name: "Doubles", level: 88, category: "Playing Style" },
      { name: "Agility", level: 96, category: "Physical" },
      { name: "Strategy", level: 92, category: "Mental" },
      { name: "Endurance", level: 89, category: "Physical" },
      { name: "Net Play", level: 91, category: "Technical" }
    ],
    achievements: [
      { id: 1, title: "Gold Medal - National Games", year: "2025", category: "Championship", description: "Gold medal winner in women's singles at National Games" },
      { id: 2, title: "University Champion 2024", year: "2024", category: "Championship", description: "Won LUMS inter-university badminton championship" },
      { id: 3, title: "Rising Star Award", year: "2024", category: "Recognition", description: "Awarded for outstanding performance by young athletes" },
      { id: 4, title: "Best Female Athlete 2024", year: "2024", category: "Individual", description: "Recognized as the top female athlete in university sports" },
      { id: 5, title: "Regional Champion 2023", year: "2023", category: "Championship", description: "First major championship victory at regional level" }
    ],
    tournaments: [
      { id: 1, name: "National Games - Women's Singles", date: "April 2025", position: "1st Place", prize: "$8,000", participants: 48 },
      { id: 2, name: "LUMS Badminton Championship", date: "March 2025", position: "1st Place", prize: "$1,500", participants: 16 },
      { id: 3, name: "Punjab State Badminton", date: "February 2025", position: "1st Place", prize: "$3,000", participants: 32 },
      { id: 4, name: "University League Finals", date: "January 2025", position: "2nd Place", prize: "$1,200", participants: 24 }
    ],
    gallery: [
      { id: 1, url: athlete2, caption: "National Games Victory", date: "2025-04-20" },
      { id: 2, url: athlete2, caption: "Training Intensive", date: "2025-03-15" },
      { id: 3, url: athlete2, caption: "Award Ceremony", date: "2025-02-10" }
    ],
    socialLinks: {
      instagram: "https://instagram.com/fatimakhan_badminton",
      twitter: "https://twitter.com/fatimakhan24",
      facebook: "https://facebook.com/fatimakhan.badminton",
      email: "fatima.khan24@lums.edu.pk",
      phone: "+92 300 9876543",
      website: "https://fatimakhan-badminton.com"
    },
    personalInfo: {
      age: 21,
      height: "5'6\"",
      weight: "60 kg",
      playingStyle: "Aggressive baseline player",
      grip: "Universal grip",
                  ...
                  <Card className="bg-card border-border/50">
                    ...
                    <CardContent>
                      <div className="space-y-6">
                        <div>
                          <h3 className="font-semibold mb-4">Playing Styles</h3>
                          <div className="space-y-4">
                            {athleteData.specialties.filter(s => s.category === "Playing Style").map((skill) => (
                              <div key={skill.name}>
                        ...
                        <div>
                          ...
                          <div className="space-y-4">
                            {athleteData.specialties.filter(s => s.category === "Physical").map((skill) => (
                              <div key={skill.name}>
                                <div className="flex justify-between text-sm mb-1">
                                  <span>{skill.name}</span>
                                  <span className="text-muted-foreground">{skill.level}%</span>
...
export default FatimaKhanProfile;